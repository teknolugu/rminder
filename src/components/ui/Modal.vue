  ...
  <div class="modal-ui">
    ...
    <teleport :to="teleportTo" :disabled="disabledTeleport">
      <transition name="modal" mode="out-in">
        <div
          v-if="show"
          class="bg-black overflow-y-auto bg-opacity-20 modal-ui__content-container z-50 flex justify-center items-end md:items-center"
          :style="{ 'backdrop-filter': blur && 'blur(2px)' }"
          @click.self="closeModal"
        >
          <slot v-if="customContent"></slot>
          <div v-else class="modal-ui__content shadow-xl rounded-t-xl bg-white p-4 w-full">
            <div class="mb-4">
