<template>
  <div
    class="ui-switch relative inline-flex h-6 w-12 justify-center items-center bg-white bg-opacity-10 p-1 rounded-full"
  ...
  >
    ...
    <div
      class="ui-switch__background absolute h-full rounded-md w-full left-0 top-0 bg-primary"
    ></div>
  </div>
</template>
<script>
